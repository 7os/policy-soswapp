...
<html lang="en" dir="ltr" manifest="<?php echo WHOST; ?>/site.webmanifest">
  <head>
    <meta charset="utf-8">
    <title>Privacy Policy | <?php echo PRJ_TITLE; ?></title>
  ...
  <body>
    <?php \TymFrontiers\Helper\setup_page('policy','base', true, PRJ_HEADER_HEIGHT); ?>
    <?php include PRJ_INC_HEADER; ?>
    <section id="main-content">
      <div class="view-space">
        <div class="sec-div padding -p10">
          <?php
          if (\file_exists(PRJ_ROOT . "/src/prj-policy-privacy.md") && $policy = \file_get_contents(PRJ_ROOT . "/src/prj-policy-privacy.md")) {
